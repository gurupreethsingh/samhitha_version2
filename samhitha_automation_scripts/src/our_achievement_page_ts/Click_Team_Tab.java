...
public class Click_Team_Tab {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement Click_Team = driver.findElement(By.xpath("//a[@title='Team']"));
		Thread.sleep(1000);
		act.moveToElement(Click_Team).click().perform();
		Thread.sleep(2000);
		{
			System.out.println("Team page is open on new tab");
		}
