...
public class Click_News_Tab {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement Click_New_Tab = driver.findElement(By.xpath("//a[@title='News']"));
		Thread.sleep(1000);
		act.moveToElement(Click_New_Tab).click().perform();
		Thread.sleep(2000);
		{
			System.out.println("News page is open on new tab");
		}
