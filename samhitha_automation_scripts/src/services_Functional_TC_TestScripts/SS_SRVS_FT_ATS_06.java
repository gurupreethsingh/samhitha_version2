...
//when user hovers or takes the mouse pointer on  'Industries' link / tab in Services page should display sub menus
public class SS_SRVS_FT_ATS_06 {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			WebElement Industries = driver.findElement(By.xpath("//a[@title='Industries']"));

			wait.until(ExpectedConditions.elementToBeClickable(Industries));
